...
#================1.原始音频信号,时域信息=================================
sameple_rate,sigs = wf.read(r'D:\guitar_coach\6.wav')
...
plt.grid(linestyle=':')
plt.plot(times[:387072],sigs[:387072],color='dodgerblue',label='Noised Signal')
plt.legend()
...
#print(fun_freq)
noised_idx = np.where(abs(freqs) >= 300)[0] #获取所有噪声的下标
ca = complex_arry[:]
...
wf.write(r'D:\guitar_coach\denoise.wav',sameple_rate,filter_sigs)
